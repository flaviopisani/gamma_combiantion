...
/*
// input kenzie //
double param[N1DPLOT] = {-0.001580, 0.000905, 0.736818, 0.972278, 0.745431, 
			  134.3922, 190.7722, 198.8409, 342.0325, 140.0116,
			  354.5104, 186.3964, 356.3099, 77.12481, 0.370171,
			  0.808433, 0.949141, 1.000000, 0.957891, 0.303014,
			 -0.025357, 0.055005, 0.059066, 0.044729, 0.608493,
			  0.104595, 0.076904, 0.225602, 0.003696, 0.006533,
			  1.488028, 1.024576, 334.9129, 0.209574, 72.72495,
			  0.052275, 0.954758};
*/
...
x_min[ 9 ]  =   110;    x_max[ 9 ] =   160;		//-180; 180
x_min[ 10 ] =      0;    x_max[ 10 ] =  360;
x_min[ 11 ] =    130;    x_max[ 11 ] =  270;		//200; 580
x_min[ 12 ] =    300;    x_max[ 12 ] =  420;		//200; 580
x_min[ 13 ] =   0;    x_max[ 13 ] =  180;		// -180; 180		50 120
...
x_min[ 25 ] =   0.05;    x_max[ 25 ] = 0.16;		//0.05; 0.16
if(mode != mode_to_str[8])
  { x_min[ 25 ] = 0.08;      x_max[ 25 ] = 0.125;}
if(mode == mode_to_str[4])
  { x_min[ 25 ] = 0.0;      x_max[ 25 ] = 1.0;}
x_min[ 26 ]      = 0;    x_max[ 26 ] = 0.14;		//0; 0.34
x_min[ 27 ]      = 0.075;    x_max[ 27 ] =  0.35;		//0; 0.7
