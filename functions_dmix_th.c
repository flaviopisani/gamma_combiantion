...
double Integral_plus = 1.;
double Integral_minus = 0.;
//double Integral_x = 0.;
//double Integral_y = 0.;
//
...
(double r_B_h, double r_f, double delta_B_h, double delta_f, double gamma, double k_B_h, double k_f, double xD, double yD, double Mxy)
{
	...
	double Integral_x =  Mxy*xD;
        amplitude += IPlus_BMinus_favored (r_B_h, r_f, delta_B_h, delta_f, gamma, k_B_h, k_f) * Integral_plus;
        amplitude += IMinus_BMinus_favored(r_B_h, r_f, delta_B_h, delta_f, gamma, k_B_h, k_f) * Integral_minus;
...
(double r_B_h, double r_f, double delta_B_h, double delta_f, double gamma, double k_B_h, double k_f, double xD, double yD, double Mxy)
{
	...
	double Integral_y = -Mxy*yD;
	double Integral_x =  Mxy*xD;
        amplitude += IPlus_BMinus_suppressed (r_B_h, r_f, delta_B_h, delta_f, gamma, k_B_h, k_f) * Integral_plus;
        amplitude += IMinus_BMinus_suppressed(r_B_h, r_f, delta_B_h, delta_f, gamma, k_B_h, k_f) * Integral_minus;
