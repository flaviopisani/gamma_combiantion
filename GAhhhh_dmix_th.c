...
k_B_h           = 1.;
g               = gamma;
double num_r_CP_4Pi_th = 0.;
num_r_CP_4Pi_th += Gamma_BMinus_suppressed(r_B_h, r_f, delta_B_h, delta_f, g, k_B_h, k_f, xD, yD, 0);
num_r_CP_4Pi_th += Gamma_BPlus_suppressed (r_B_h, r_f, delta_B_h, delta_f, g, k_B_h, k_f, xD, yD, 0);
double den_r_CP_4Pi_th = 0.;
r_f             = r_D_K3Pi;
delta_f         = delta_D_K3Pi;
k_f             = k_D_K3Pi;
den_r_CP_4Pi_th += Gamma_BMinus_favored(r_B_h, r_f, delta_B_h, delta_f, g, k_B_h, k_f, xD, yD, Mxy);
den_r_CP_4Pi_th += Gamma_BPlus_favored (r_B_h, r_f, delta_B_h, delta_f, g, k_B_h, k_f, xD, yD, Mxy);

double r_CP_4Pi_th = num_r_CP_4Pi_th / den_r_CP_4Pi_th;

//      printf("Test hhhh: %f %f\n",r_CP_4Pi_th,r_CP_4Pi_th2);


TVectorD GAhhhh_x_obs_min_x_th(5);
GAhhhh_x_obs_min_x_th(0) = a_ADS_K_K3Pi  - a_ADS_DK_K3Pi_th;
GAhhhh_x_obs_min_x_th(1) = a_CP_DK_4Pi   - a_CP_DK_4Pi_th;
GAhhhh_x_obs_min_x_th(2) = a_fav_DK_K3Pi - a_fav_DK_K3Pi_th;
GAhhhh_x_obs_min_x_th(3) = r_ADS_K_K3Pi  - r_ADS_DK_K3Pi_th;
