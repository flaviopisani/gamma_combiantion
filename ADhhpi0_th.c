...
double a_ADS_K_KPiPi0_th        = (2. * k_D_KPiPi0 * r_B_DK * r_D_KPiPi0 * sin((delta_B_DK + delta_D_KPiPi0)/180.*M_PI) * sin(gamma/180.*M_PI)) /
...
// equation (234)
double r_ADS_K_KPiPi0_th        = (r_B_DK * r_B_DK + r_D_KPiPi0 * r_D_KPiPi0 + 2. * k_D_KPiPi0 * r_B_DK * r_D_KPiPi0 * cos((delta_B_DK + delta_D_KPiPi0)/180.*M_PI) * cos(gamma/180.*M_PI)) /
  (1. + r_B_DK * r_B_DK * r_D_KPiPi0 * r_D_KPiPi0 +  2. * k_D_KPiPi0 * r_B_DK * r_D_KPiPi0 * cos((delta_B_DK - delta_D_KPiPi0)/180.*M_PI) * cos(gamma/180.*M_PI));
...
ADhhpi0_x_min_x_th(0)       = a_ADS_K_KPiPi0  - a_ADS_K_KPiPi0_th;
...
ADhhpi0_x_min_x_th(4)       = r_ADS_K_KPiPi0  - r_ADS_K_KPiPi0_th;
