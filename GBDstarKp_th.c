...
double a_CP_D_gamma_th    = (-2. * r_B_DstarK * sin(delta_B_DstarK/180.*M_PI) * sin(gamma/180.*M_PI))/
  (1. + r_B_DstarK * r_B_DstarK  - 2. * r_B_DstarK * cos(delta_B_DstarK/180.*M_PI) * cos(gamma/180.*M_PI)) + (a_CP_dir_PiPi/(0.0015*0.0015)+a_CP_dir_KK/(0.0014*0.0014))/(1/(0.0015*0.0015)+1/(0.0014*0.0014));
